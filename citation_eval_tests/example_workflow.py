...
def load_test_data(data_dir='citation_eval_tests/test_data'):
    """Load test data for evaluation."""
    data_path = Path(data_dir)
    
    # Load hierarchy
    with open(data_path / "test_hierarchy.json", 'r') as f:
    ...
    # Load citations
    citations = pd.read_csv(data_path / "test_citations.csv")
...
def run_example_evaluation():
    ...
    # Load test data
    hierarchy, citations = load_test_data()
